...
# 1. Lista de 1 EAN complejo
eans_test = [
    {"ean": "0000000072410", "desc": "Amoxicilina/Ácido Clavulánico 875 mg/125 mg x 10 tabletas"}
]

import orquestador_scraper_v11 as scrap
...
with open("scratch/1_prueba_raw.json", "w", encoding="utf-8") as f:
    json.dump(resultados_scraping, f, ensure_ascii=False, indent=2)

print("Scraping completado. Ejecutando evaluate_optimized...")

import scratch.evaluate_optimized as ev
ev.main(input_path="scratch/1_prueba_raw.json", comp_path="scratch/1_prueba_resultados.json", excel_path="scratch/1_prueba_excel.xlsx")
