...
def update_lote6():
    ...
    with open('scratch/compact_400_6.txt', 'r', encoding='utf-8') as f:
        for line in f:
    ...
    try:
        ...
        print(f"Lote 6: Actualizados {count_updated} campos de fabricante de {len(codbarras_procesados)} registros leídos.")
        ...
        print("Error en actualizacion lote 6:", e)
    finally:
        conn.close()
