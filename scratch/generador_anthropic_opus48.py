...
# Importamos la lógica, lo cual configurará DeepSeek por defecto
from generador import generate_prompt, api_key

# Sobrescribimos el LM global de DSPy para usar el Claude Opus 4.8
lm_opus = dspy.LM(
...
print("Generando con Claude Opus 4.8 vía OpenRouter...")
resultado = generate_prompt(idea)

output_path = "/home/synapse/source/repos/Clasificacion Medicamentos/prompt_agente_v3_opus48.txt"
with open(output_path, "w", encoding="utf-8") as f:
    f.write(resultado["prompt_optimizado"])

reasoning_path = "/home/synapse/source/repos/Clasificacion Medicamentos/scratch/reasoning_v3_opus48.txt"
with open(reasoning_path, "w", encoding="utf-8") as f:
    f.write(resultado["reasoning"])

print("Consolidación completa. Guardado en prompt_agente_v3_opus48.txt")
print(f"Tamaño original V2: {os.path.getsize(prompt_path)} bytes")
print(f"Tamaño V3 Opus 4.8: {os.path.getsize(output_path)} bytes")
