...
if __name__ == "__main__":
    ...
    mod = "deepseek/deepseek-v4-pro" # Query the specific DeepSeek V4 Pro model on OpenRouter
    ...
    with open('/home/synapse/source/repos/Clasificacion Medicamentos/scratch/deepseek_v4_pro_30_complex.json', 'w', encoding='utf-8') as f:
        json.dump(resultado, f, indent=2, ensure_ascii=False)
    print("\nBenchmark DeepSeek V4 Pro completado. Datos guardados.")
