...
with open("scratch/2_complejos_raw.json", "w", encoding="utf-8") as f:
...
ev.main(input_path="scratch/2_complejos_raw.json", comp_path="scratch/2_complejos_resultados.json", excel_path="scratch/2_complejos_excel.xlsx")
